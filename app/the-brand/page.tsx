...
export default function TheBrandPage() {
    ...
    // Helper para asignar iconos según el índice del capítulo (ya que la API no trae el nombre del icono)
    const getChapterIcon = (index) => {
        const icons = [
            <MapPin className="w-4 h-4" />, // Índice 0
            <Search className="w-4 h-4" />, // Índice 1
            <Diamond className="w-4 h-4" /> // Índice 2
        ];
